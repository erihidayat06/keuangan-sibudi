...
<body>
    ...
    <div class="isi align-justify">
        ...
        {{-- Breack --}}
        <div class="page-break"></div>
        <p>D. SASARAN KINERJA </p>
        <div class="isi">
            @include('proker.pdf.sasaran')
        </div>
        <p>E. Rencana Kegiatan / Program </p>
        <div class="isi">
            @include('proker.pdf.rencana_kegiatan')
        </div>
        <p>F. Rencana Kerjasama </p>
        <div class="isi">
            @include('proker.pdf.rencana_kerjasama')
        </div>
        {{-- Breack --}}
        <div class="page-break"></div>
        @include('proker.pdf.penambahan_modal')
    </div>
</body>
