            ...
            <div class="row">
                ...
                <div class="col-xxl-4 col-md-6">
                    <div class="card info-card sales-card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Total <span>| Inventris</span></h5>
            ...
            <div class="card overflow-auto">
                <div class="card-body">
                    ...
                    <div class="row cols-2 cols-lg-2">
                        <div class="col">
                            <a href="/aset/bangunan/create" class="btn btn-sm btn-primary mb-3">Tambah Data</a>
                        </div>
                        <div class="col text-end">
                            <a href="/export-pdf/bangunan" class="btn btn-danger"><i class="bi bi-filetype-pdf"></i> PDF</a>
                        </div>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-start">
                                            <a href="/aset/bangunan/{{ $aset->id }}/edit"
                                                class="btn btn-sm btn-success">
                                                <i class="bi bi-pencil-square"></i></a>
                                            <form action="/aset/bangunan/{{ $aset->id }}" class="ms-2"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
