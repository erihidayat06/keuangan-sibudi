...
class ProfileController extends Controller
{
    ...
    public function update(Request $request, Profil $profil)
    {
        ...
        $request->validate([
            'nm_bumdes' => 'nullable|string|max:255',
            'desa' => 'nullable|string|max:255',
            'kecamatan' => 'nullable|string|max:255',
            'nm_direktur' => 'nullable|string|max:255',
            'nm_sekertaris' => 'nullable|string|max:255',
            'nm_bendahara' => 'nullable|string|max:255',
            'nm_pengawas' => 'nullable|string|max:255',
            'nm_penasehat' => 'nullable|string|max:255',
            'unt_usaha1' => 'nullable|string|max:255',
            'nm_kepyun1' => 'nullable|string|max:255',
            'unt_usaha2' => 'nullable|string|max:255',
            'nm_kepyun2' => 'nullable|string|max:255',
            'unt_usaha3' => 'nullable|string|max:255',
            'nm_kepyun3' => 'nullable|string|max:255',
            'unt_usaha4' => 'nullable|string|max:255',
            'nm_kepyun4' => 'nullable|string|max:255',
            'no_badan' => 'nullable|string|max:255',
            'no_perdes' => 'nullable|string|max:255',
        ...
        $bumdes->update([
            ...
            'nm_sekertaris' => $request->nm_sekertaris,
